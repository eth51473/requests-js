...
sayHelloButton.addEventListener('mouseout',restoreBtn)
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/:hooplah')
    .then((res) => {
...
// CODE HERE
const sendQuery = () => {
    axios.get('http://localhost:3000/query-test/?name=Ethan')
...
/*
    ...
    // it said, you sent an empty query
    2: Send more than 1 query on the URL -- what happened? 
*/  // It told me I sent more than 1 query and the queries appeared under my data
...
function createFood(event){
    ...
    .then((res) => {
            ...
            newh5.textContent = res.data
            document.querySelector('body').appendChild(newh5)
